...
3. 세 번째 강의 https://github.com/bjmin/bmin_comphys/blob/master/ml03/class.md (Linear Regression)
4. 네 번째 강의 https://github.com/bjmin/bmin_comphys/blob/master/ml04/class.md (Classification: Logistic Regression)
