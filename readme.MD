...
2. 두 번째 강의 https://github.com/bjmin/bmin_comphys/blob/master/cp02/class.md (리스트/배열/함수/입출력)
3. 세 번째 강의 https://github.com/bjmin/bmin_comphys/blob/master/cp03/class.md (matplotlib)
4. 네 번째 강의 (list comprehension/lambda function/문자열/디버깅)
5. 다섯 번째 강의
